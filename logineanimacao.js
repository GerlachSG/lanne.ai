...
document.querySelector('.card-button').addEventListener('click', function() {
 ...
 // Animação de voltar do card - Edu
  ...
  googleLogin.addEventListener("click", function() {
    ...
    signInWithPopup(auth, googleprovider)
      .then((result) => {
        ...
        window.location.href = "https://igorgerlach.github.io/lanne.ai/logged.html"; // Redireciona após o login
      })
      .catch((error) => {
  ...
  .then((result) => {
    ...
    console.log(user);
     // PARTE DE REDIRECIONAR
    window.location.href = "https://igorgerlach.github.io/lanne.ai/logged.html";
