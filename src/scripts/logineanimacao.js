  ...
  card.innerHTML = `
    ...
    <div class="button-wrapper2">
      <button class="login-button facebook">
        <img src="../imagens/facebook-icon.svg" alt="Facebook" class="icon">
        Faça login com<span class="bold-text">Facebook</span>
      </button>
      <button class="login-button google">
        <img src="../imagens/google-icon.svg" alt="Google" class="icon">
  ...
  googleLogin.addEventListener("click", function() {
    ...
    signInWithPopup(auth, googleprovider)
      .then((result) => {
        ...
        window.location.href = "https://gerlachsg.github.io/lanne.ai/chat.html"; // Redireciona após o login
      })
      .catch((error) => {
